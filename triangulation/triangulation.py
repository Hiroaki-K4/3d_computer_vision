...
def optimal_correction(F, f_0, points_0, points_1):
    ...
    while True:
        V0_xi = np.array([[x_est_0**2+x_est_1**2, x_est_1*y_est_1, f_0*x_est_1, x_est_0*y_est_0, 0, 0, f_0*x_est_0, 0, 0],
                        [x_est_1*y_est_1, x_est_0**2+y_est_1**2, f_0*y_est_1, 0, x_est_0*y_est_0, 0, 0, f_0*x_est_0, 0],
                        [f_0*x_est_1, f_0*y_est_1, f_0**2, 0, 0, 0, 0, 0, 0],
                        [x_est_0*y_est_0, 0, 0, y_est_0**2+x_est_1**2, x_est_1*y_est_1, f_0*x_est_1, f_0*y_est_0, 0, 0],
                        [0, x_est_0*y_est_0, 0, x_est_1*y_est_1, y_est_0**2+y_est_1**2, f_0*y_est_1, 0, f_0*y_est_0, 0],
        ...
        xi = np.array([x_est_0*x_est_1+x_est_1*x_move_0+x_est_0*x_move_1,
        ...
        theta = np.array([F[0,0], F[0,1], F[0,2], F[1,0], F[1,1], F[1,2], F[2,0], F[2,1], F[2,2]])
        theta_arr_0 = np.array([[theta[0], theta[1], theta[2]],
                            [theta[3], theta[4], theta[5]]])
        theta_arr_1 = np.array([[theta[0], theta[3], theta[6]],
                            [theta[1], theta[4], theta[7]]])
        point_move_0 = np.dot(np.dot(np.dot(xi, theta) / np.dot(theta, np.dot(V0_xi, theta)), theta_arr_0), np.array([x_est_1, y_est_1, f_0]))
        point_move_1 = np.dot(np.dot(np.dot(xi, theta) / np.dot(theta, np.dot(V0_xi, theta)), theta_arr_1), np.array([x_est_0, y_est_0, f_0]))
